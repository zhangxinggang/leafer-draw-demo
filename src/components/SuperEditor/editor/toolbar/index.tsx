...
export default function Toolbar() {
  ...
  const icons: IconProps[] = [
    ...
    },
    {
      ...
      icon: <BorderOutlined style={{ fontSize: 18 }} />,
      onClick: () => {
    ...
    },
    {
      ...
      icon: <SvgIcon name={'circle'} style={{ width: 18 }} />,
      onClick: () => {
    ...
    },
    {
      name: 'huabi',
      size: 20,
      icon: <HighlightOutlined style={{ fontSize: 18 }} />,
    ...
    },
    {
      name: 'tupian',
      size: 20,
      icon: <FileImageOutlined style={{ fontSize: 18 }} />,
