import { ArrowCmp, Cmp, CmpType, ImageCmp, PathCmp, PenCmp, TextCmp } from '../../interface/cmp';
...
export function generateCmp(
  ...
  let { startX, startY, endX, endY, leaferAttr } = datas;
  ...
  if ([CmpType.Rect, CmpType.Ellipse, CmpType.RectLine].includes(cmpType)) {
